...
- Let density rise and fall in contiguous regions. Quiet space must remain perceptually quiet at thumbnail scale. It may be crossed by a few sparse, low-contrast long-range lines that belong to the main route; it stops being quiet when repeated arcs, grids, grain, fragments, or accents create another high-frequency system.
...
- Quiet regions remain perceptually quiet at thumbnail scale. Sparse low-contrast lines may cross them when those lines continue the main scaffold; paper tone alone does not count when repeated arcs, grids, grain, fragments, or accents create a competing texture or gesture.
